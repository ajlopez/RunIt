...
function load(name, verb, options, cb) {
    ...
    if (options.directory) {
        filename = path.join(options.directory, namespace, 'modules', name, verb + '.js');
        ...
        filename = path.join(options.directory, namespace, 'modules', name, 'index.js');
    ...
    filename = path.join('.', namespace, 'modules', name, verb + '.js');
    ...
    filename = path.join('.', namespace, 'modules', name, 'index.js');
